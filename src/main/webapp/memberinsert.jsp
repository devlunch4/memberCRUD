					...
					<div class="container-fluid">
						...
						<div class="card">
							<div class="register-card-body">
								<form role="form" class="form-horizontal" action="/userRegist"
									method="post" enctype="multipart/form-data">
									<input type="hidden" name="userid" value="" /> <input
										type="hidden" name="reg_dt" value="2020.01.21" />
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input name="userId" type="text" class="form-control"
												id="userId" placeholder="회원 Id" required="required"
												value="${param.userId }" />
										</div>
										<div class="x"
											style="position: relateive; text_align: center; background-color: yellow; margin: auto;">
											${notice }</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="pass" type="password"
												id="pass" placeholder="비밀번호" required="required"
												value="${param.pass }" />
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="userNm" type="text"
												id="userNm" placeholder="이름" required="required"
												value="${param.userNm }" />
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="userAlias" type="text"
												id="userAlias" placeholder="별명" value="${param.userAlias }">
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="row">
											...
											<div class="col-sm-6">
												<button type="button" id="cancelBtn"
													onclick="location.href='/userRegistC'"
